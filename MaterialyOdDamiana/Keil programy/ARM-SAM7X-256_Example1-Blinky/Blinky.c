...
#define LED_BCK_OFF		LED_PIO->PIO_CODR = AT91C_PIO_PB19
#define LED_BCK_ON		LED_PIO->PIO_SODR = AT91C_PIO_PB19
...
if (RIGHT_KEY_DOWN)
{	
	//opóznienie po wykryciu wcisniecia
//(zabezpieczenie na „zboczu opadajacy” sygnalu – rys. 2a)
//oczekiwanie na puszczenie klawisza
while (RIGHT_KEY_DOWN)
{
LED_BCK_ON;
delay(1000);
LED_BCK_OFF;
